...
const ITEMS = [
  { src: "/images/portait.PNG", label: "Индивидуальная фотосессия" },
  { src: "/images/portait-1.JPG", label: "Индивидуальная фотосессия" },
  { src: "/images/portrait-2.JPG", label: "Индивидуальная фотосессия" },
  { src: "/images/portrait-3.JPEG", label: "Индивидуальная фотосессия" },
];

const N = ITEMS.length;

export function IndividualOnlyCarousel() {
      ...
      {zoomedSrc && isMounted
        ? createPortal(
            ...
            >
              ...
              <img
                src={zoomedSrc}
                alt="Индивидуальный портрет в zoom"
