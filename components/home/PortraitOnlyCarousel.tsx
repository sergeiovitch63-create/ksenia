...
const ITEMS = [
  { src: "/images/portait.PNG", label: "Портрет" },
  { src: "/images/portait-1.JPG", label: "Портрет" },
  { src: "/images/portrait-2.JPG", label: "Портрет" },
  { src: "/images/portrait-3.JPEG", label: "Портрет" },
];

const N = ITEMS.length;

export function PortraitOnlyCarousel() {
