...
const ITEMS = [{ src: "/images/familly.CR2", label: "Семья" }];
const N = ITEMS.length;

export function FamilyOnlyCarousel() {
  ...
  const layout = useCallback(() => {
    ...
    cards.forEach((card, i) => {
      ...
      card.style.transform = "translateX(0) translateY(0) rotateY(0deg) rotateX(0deg) scale(1) translateZ(0)";
