...
import { IndividualOnlyCarousel } from "@/components/home/IndividualOnlyCarousel";
import SeanceExtras from "@/components/SeanceExtras";
...
export default function IndividualSeancePage() {
  ...
  return (
    <>
      ...
      <SeanceExtras currentSlug="individualnaya" />
